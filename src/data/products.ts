...
export const allProducts: Product[] = [
  {
    ...
    longDescription: "Nuestra mermelada de higo es elaborada artesanalmente por Don Manuel, quien a sus 78 años conserva la receta familiar que ha pasado por tres generaciones. Cada frasco contiene higos cuidadosamente seleccionados de huertos locales de Oaxaca, cocidos a fuego lento con el punto exacto de azúcar de caña que solo la experiencia puede determinar.",
